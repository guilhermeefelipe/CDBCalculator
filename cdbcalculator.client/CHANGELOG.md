...
- Create Angular project with ng: `ng new cdbcalculator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`cdbcalculator.client.esproj`).
